...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password === $confirmPassword) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO Users (name, email, password, address, phone, city_code) VALUES (?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("ssssss", $username, $email, $hashedPassword, $homeAddress, $phoneNumber, $cityCode); // Bind the hashed password
